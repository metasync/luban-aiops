...
E["Policy Engine<br/>evaluate()"]
F["Confirm Bridge<br/>POST /api/v1/chat/confirm"]
end
subgraph "Shared Contracts"
G["chat-confirm.schema.json"]
H["policy-decision.schema.json"]
I["policy-default.yaml"]
end
A --> B
B --> C
A --> D
...
- Write-tier tools include web.click, web.type, web.select, web.press_key, web.upload_file, and web.evaluate; read-tier probes bypass this path
...
Together, these mechanisms ensure risky operations execute only with explicit, auditable, and policy-compliant human approval.
