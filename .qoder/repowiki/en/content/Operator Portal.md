...
## Update Summary
**Changes Made**
- Enhanced session availability gate for incident chat with disabled 'Continue in chat' button when sessions are unavailable
- Improved error handling for draft functionality with better user feedback
- Enhanced user feedback for expired or foreign sessions with clearer messaging
- Updated incident management interface to provide better session state validation and user guidance
