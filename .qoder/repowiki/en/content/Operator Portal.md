...
Y[Session Detail API] --> Z[Re-seed Timeline via reseedTurns]
end
subgraph "Authoritative Re-seed Mechanism"
AA[reseedTurns Method] --> BB[Same-Session Only Check]
CC[Live Turns Replacement] --> DD[Cache Entry Replacement]
