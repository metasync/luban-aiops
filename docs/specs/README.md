...
| `SPEC-036` | Server inbox pagination and seeded transcript reveal — split inbox store queries, paginated inbox API with totals, gateway pass-through, server-driven History tab, and typewriter reveal on cold-seeded transcripts (extends SPEC-031/SPEC-035) | `delivered` |
