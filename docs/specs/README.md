...
| `SPEC-031` | Approval inbox and persistent confirmation cards — durable confirmation records, owner-side cards surviving re-login, decider-scoped approvals inbox with history, race-resilient `already_resolved` semantics (extends SPEC-020/022/030) | `draft` |
