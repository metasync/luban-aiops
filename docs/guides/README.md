...
| [Studio Guide](studio-guide.md) | Skill development in the portal: Chat vs Studio, your first development session end to end, graduation refusals, and why a session's type never changes |
