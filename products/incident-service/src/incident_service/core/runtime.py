...
class IncidentRunSettings:
    host: str = DEFAULT_HTTP_HOST
    port: int = DEFAULT_HTTP_PORT

    @classmethod
    def from_env(cls) -> "IncidentRunSettings":
        return cls(
            host=os.getenv("INCIDENT_HOST", DEFAULT_HTTP_HOST),
            port=_resolve_port(os.getenv("INCIDENT_PORT"), DEFAULT_HTTP_PORT),
        )
