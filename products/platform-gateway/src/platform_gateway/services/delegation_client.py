...
class DelegationClient:
    ...
    async def exchange(self, settings: PlatformGatewaySettings, subject_token: str) -> tuple[str, int]:
    ...
    def _read_workload_token(self, settings: PlatformGatewaySettings) -> str | None:
    ...
    def mint_dev_subject_token(self, settings: PlatformGatewaySettings) -> str:
    ...
    def _load_dev_key(self, settings: PlatformGatewaySettings) -> rsa.RSAPrivateKey:
